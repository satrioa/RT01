...
// demo icons not needed for generic drawer — replaced with lucide placeholders
const BannedIcon = () => <div className="size-6 bg-muted rounded-full" />;
const DangerIcon = () => <div className="size-6 bg-destructive/20 rounded" />;
const FaceIDIcon = () => <div className="size-6 bg-primary/10 rounded" />;
const LockIcon = () => <div className="size-6 bg-muted rounded" />;
const PassIcon = () => <div className="size-6 bg-muted rounded" />;
const PhraseIcon = () => <div className="size-6 bg-muted rounded" />;
const RecoveryPhraseIcon = () => <div className="size-6 bg-muted rounded" />;
const ShieldIcon = () => <div className="size-6 bg-muted rounded" />;
const WarningIcon = () => <div className="size-6 bg-amber-200 rounded" />;
