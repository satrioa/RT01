...
export const AI_PROVIDERS: AiProviderOption[] = [
  {
    ...
    models: [
      ...
      { id: "google/gemini-2.0-flash-001", label: "Gemini 2.0 Flash 001", description: "Google — dari .env Anda" },
      { id: "google/gemini-2.0-flash-exp:free", label: "Gemini 2.0 Flash Exp (free)", description: "Google — free tier" },
      { id: "google/gemini-2.0-flash:free", label: "Gemini 2.0 Flash (free)", description: "Google — free" },
