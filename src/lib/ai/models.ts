...
export const AI_PROVIDERS: AiProviderOption[] = [
  {
    ...
    models: [
      ...
      { id: "google/gemini-2.5-flash", label: "Gemini 2.5 Flash", description: "Google — stabil" },
      { id: "google/gemini-2.5-flash-lite", label: "Gemini 2.5 Flash Lite", description: "Google — ringan" },
  ...
  },
  {
    ...
    models: [
      { id: "gemini-2.5-flash", label: "Gemini 2.5 Flash", description: "Rekomendasi — stabil", recommended: true },
      { id: "gemini-2.5-flash-lite", label: "Gemini 2.5 Flash Lite", description: "Ringan" },
      { id: "gemini-3.0-flash-preview", label: "Gemini 3.0 Flash Preview", description: "Terbaru (preview)" },
