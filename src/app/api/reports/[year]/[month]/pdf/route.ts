...
export async function GET(
  ...
  const pocket = req.nextUrl.searchParams.get("pocket"); // pocketId or "rekap"
  ...
  try {
    ...
    return new NextResponse(buf as unknown as BodyInit, {
      headers: {
        ...
        "Content-Disposition": `attachment; filename="laporan-${slug}-${year}-${String(month).padStart(2, "0")}.pdf"`,
